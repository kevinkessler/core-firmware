...
#define _CPAL_TIMEOUT_INIT()		i2cTimerInit()
...
#define _CPAL_TIMEOUT_DEINIT()		i2cTimeDeInit()
...
#ifdef CPAL_DEBUG
#define CPAL_LOG(Str)                   DEBUG(Str)
#include <debug.h>                     /* This header file must be included when using CPAL_DEBUG option   */
#else
